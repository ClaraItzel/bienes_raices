function eventListeners(){document.querySelector(".mobile__img").addEventListener("click",navResponsive)}function navResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");e.matches?document.body.classList.add("darkmode-action"):document.body.classList.remove("darkmode-action"),e.addEventListener("change",()=>{e.matches?document.body.classList.add("darkmode-action"):document.body.classList.remove("darkmode-action")});document.querySelector(".darkmode").addEventListener("click",()=>{document.body.classList.toggle("darkmode-action")})}
